...
更详细的参与方式见 [CONTRIBUTING.md](CONTRIBUTING.md)。协作规则、决策方式和成员结构见 [GOVERNANCE.md](GOVERNANCE.md)。半正式讨论（术语、版本考证、翻译认领）在仓库的 [Discussions](https://github.com/hoshF/Ilyenkov-cn/discussions) 进行，即时交流可加入 [Telegram 群](https://t.me/+08chEHSg8nhhZTg1)；微信群不公开入口，请通过 Telegram 或 Discussions 私下联系维护者。
